"""
notebook_voxtral_small.py — Benchmark: Voxtral Small 24B (whole audio)
=======================================================================
Model:   "mistral/voxtral-small-24b-2507"
API:     Scaleway (OpenAI-compatible endpoint)

Identical structure to notebook_voxtral_mini.py — only MODEL_ID
and results filename differ.

Run:
    python notebook_voxtral_small.py
"""
...
RESULTS_PATH    = RESULTS_DIR / "results_voxtral_small.csv"
...
# ── Summary ───────────────────────────────────────────────────────────────────
print("\n" + "=" * 60)
print(f"RESULTS — Voxtral Small 24B / whole audio")
print("=" * 60)
